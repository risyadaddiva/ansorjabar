  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <p className="text-sm text-ansor-500">Belum ada berita. Tulis berita pertama kamu.</p>
      ) : (
            ...
            <tbody>
              {list.map((item) => (
                <tr key={item.id} className="border-t border-ansor-100 dark:border-ansor-800">
                  ...
                  <td className="px-4 py-3 text-ansor-500 dark:text-ansor-400">{item.kategori}</td>
