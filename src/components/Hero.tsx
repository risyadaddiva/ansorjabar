...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-ansor-600 via-ansor-700 to-ansor-800 text-white py-16 lg:py-24 shadow-xl">
      ...
      <div className="relative mx-auto max-w-7xl px-4">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
          ...
          <div className="lg:col-span-6">
            ...
            <div className="mb-6 inline-flex items-center gap-2.5 rounded-full border border-gold-300/50 bg-gold-400/20 px-4 py-1.5 backdrop-blur-md shadow-md">
            ...
            {/* Clean Bold Heading */}
            <h1 className="font-sans text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl leading-[1.12] drop-shadow-md">
              Menjaga Islam <br />
              Ahlussunnah <br />
            ...
            {/* Subtitle */}
            <p className="mt-6 max-w-lg text-base text-ansor-50/90 leading-relaxed font-medium">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <Link
                href="/berita"
                className="inline-flex items-center gap-2 rounded-full bg-gold-400 px-7 py-3.5 text-sm font-bold text-ansor-950 shadow-lg shadow-gold-500/30 transition-all duration-300 hover:bg-gold-300 hover:scale-105"
              >
              ...
              <Link
                href="/badan-lembaga"
                className="inline-flex items-center gap-2 rounded-full border border-white/40 bg-white/15 px-7 py-3.5 text-sm font-semibold text-white backdrop-blur-md transition-all duration-300 hover:bg-white/25 hover:border-white/60"
              >
          ...
          {/* ── Right Column: Concentric Orbit Rings & 3 Glassmorphism Cards ─ */}
          <div className="lg:col-span-6 relative flex items-center justify-center min-h-[460px] py-6">
            ...
            <div className="absolute top-0 right-2 w-64 rounded-2xl border border-white/30 bg-ansor-900/85 p-5 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:border-gold-300/70 hover:-translate-y-1.5 animate-float-slow">
            ...
            <div className="absolute bottom-4 left-0 w-64 rounded-2xl border border-white/30 bg-ansor-900/85 p-5 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:border-sky-300/70 hover:-translate-y-1.5 animate-float-delayed">
            ...
            <div className="absolute -bottom-4 right-4 w-64 rounded-2xl border border-white/30 bg-ansor-900/85 p-5 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:border-emerald-300/70 hover:-translate-y-1.5 animate-float-slow" style={{ animationDelay: "1s" }}>
