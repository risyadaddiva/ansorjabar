...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-ansor-600 via-ansor-700 to-ansor-800 text-white py-14 sm:py-18 lg:py-24 xl:py-28 shadow-xl">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
          ...
          {/* ── Desktop & Mobile Left Column: Original Typography & CTA ─────── */}
          <div className="col-span-12 lg:col-span-6 z-10 text-left">
            ...
            {/* Clean Bold Heading */}
            <h1 className="font-sans text-3xl font-extrabold tracking-tight text-white sm:text-4xl lg:text-5xl xl:text-6xl leading-[1.15] drop-shadow-md">
              Menjaga Islam <br />
              Ahlussunnah <br />
          ...
          {/* ── DESKTOP ONLY: Original Right Column with Floating Orbit Cards (lg:flex) ── */}
          <div className="hidden lg:flex lg:col-span-6 relative items-center justify-center min-h-[460px]">
            ...
            <div className="absolute top-0 right-0 w-64 rounded-2xl border border-white/30 bg-ansor-900/90 p-5 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:border-gold-300/70 hover:-translate-y-1.5 animate-float-slow">
            ...
            <div className="absolute top-1/2 -translate-y-1/2 left-0 w-64 rounded-2xl border border-white/30 bg-ansor-900/90 p-5 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:border-sky-300/70 hover:-translate-y-1.5 animate-float-delayed">
            ...
            <div className="absolute bottom-0 right-0 w-64 rounded-2xl border border-white/30 bg-ansor-900/90 p-5 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:border-emerald-300/70 hover:-translate-y-1.5 animate-float-slow" style={{ animationDelay: "1s" }}>
          ...
          {/* ── MOBILE ONLY: Clean Responsive Stack Below Buttons (lg:hidden) ── */}
